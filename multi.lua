...
TextChatService.OnIncomingMessage = function(Message)
	if Message.Text == SEND then do
			SEND = ""
		end
	else
		if string.match(Message.Text, Syntax) then
			local Table = string.split(Message.Text:gsub(Syntax,""),",")
...
if LocalPlayer.Name == _1 then
	...
	Button.MouseButton1Up:Connect(function()
		...
		SEND = Syntax..TextBox.Text..","..tostring(Timer)
		TextChannel:SendAsync(SEND)
	end)
end
